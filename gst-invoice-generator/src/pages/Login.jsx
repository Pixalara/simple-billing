...
const CheckItem = ({ text }) => (
  <div className="flex items-center gap-3 mb-2"> {/* Reduced margin for tighter look */}
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#0f172a] relative overflow-hidden font-sans">
      ...
      {/* --- NEW: BRAND LOGO (Fixes Top-Left Empty Space) --- */}
      <div className="absolute top-8 left-8 lg:top-12 lg:left-16 z-20 flex items-center gap-3">
          ...
          <div className="flex flex-col">
              <span className="text-xl font-bold text-white tracking-tight leading-none">Pixalara</span>
              <span className="text-xs font-medium text-cyan-400 tracking-wider uppercase">Billing</span>
          </div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto p-4 lg:p-12 flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-24">
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left space-y-6 mt-16 lg:mt-0"> {/* Adjusted spacing */}
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-600/10 border border-blue-500/30 backdrop-blur-md mx-auto lg:mx-0">
                <span className="text-xs font-bold text-cyan-300 tracking-widest uppercase">Forever Free GST Billing</span>
            </div>
