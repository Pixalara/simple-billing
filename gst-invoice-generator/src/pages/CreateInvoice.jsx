...
export default function CreateInvoice() {
  ...
  // --- UPDATED PDF GENERATOR (Fixes Empty PDF + Combines Pages) ---
  const generatePdfBlob = async () => {
      ...
      // FIX: Position fixed at top-left to be visible to renderer
      // But use z-index to hide it behind everything else
      ...
      // --- EXTRA DELAY ---
      // Give browser time to paint the new DOM nodes before capture
