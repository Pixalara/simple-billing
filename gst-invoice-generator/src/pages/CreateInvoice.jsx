...
export default function CreateInvoice() {
  ...
  // --- UPDATED GENERATE PDF BLOB FUNCTION (Combines Pages) ---
  const generatePdfBlob = async () => {
      ...
      const createCopy = (label) => {
          ...
          // Standardize classes for PDF capture
      ...
      // Position it exactly where the original single-file logic was (since that worked for you)
      ...
      if (sellerProfile?.print_duplicates) {
          ...
          // 2. Page Break (Standard HTML/CSS for printers)
      ...
      // --- ADD DELAY TO PREVENT EMPTY PDF ---
